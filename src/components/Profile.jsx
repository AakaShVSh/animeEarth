...
// /* --------------------------------------------------------------------------
//    activateStudioApi — calls POST /videos/studio/activate
//    (add this to your uploadVideo.js service file if not already there)
// -------------------------------------------------------------------------- */
...
//    Profile Page
//    Props:
//      - targetUserId (string|null) — if omitted, shows the signed-in user's profile
// ============================================================================ */
...
//   const [following, setFollowing] = useState(false); // button loading
...
//   /* ── 1. Resolve auth + determine own vs other profile ─────────────── */
//   useEffect(() => {
...
//   /* ── 2. Fetch videos (and derive profile + stats for other users) ── */
...
//         // Compute total views from loaded videos
//         setTotalViews((prev) =>
//           pg === 1
...
//         // For another user's profile, derive channel info from first video's user object
//         if (!isOwnProfile && vids.length > 0 && !profileUser) {
//           const u = vids[0].user;
//           setProfileUser(u);
...
//       }
//     },
//     [uid, isOwnProfile, currentUser, profileUser],
//   );
...
//         studioDesc.trim(),
//       );
//       // Merge updated fields into currentUser and profileUser
//       const patch = {
//         hasChannel: true,
//         channelName: studioName.trim(),
//         channelDescription: studioDesc.trim(),
//       };
...
//       return;
//     }
//     // Guard: user cannot follow their own studio
//     if (isOwnProfile) {
//       toast({
...
//       return;
//     }
//     if (String(currentUser._id) === String(profileUser?._id)) {
//       toast({
//         title: "You can't follow your own studio",
//         status: "info",
//         duration: 2000,
...
//       toast({
//         title: isFollowing ? "Unfollowed studio" : "Following! 🔔",
...
//   const hasChannel = displayUser?.hasChannel;
//   // Use studio name if set, else fall back to username
//   const studioDisplay = hasChannel
//     ? displayUser?.channelName || displayUser?.username
//     : displayUser?.username || "User";
//   const joinedYear = displayUser?.createdAt
...
//                 {hasChannel && displayUser?.username && (
//                   <Text
//                     fontSize="xs"
//                     color="purple.300"
...
//                     </>
//                   ) : (
//                     /* Other user's profile — show Follow + Share */
//                     <>
//                       <Button
//                         size="sm"
...
//                       {displayUser?.channelDescription ||
//                         (isOwnProfile
//                           ? "Add a description to your studio."
...
//                       {
//                         label: "Studio",
//                         value: hasChannel ? studioDisplay : "—",
//                       },
//                       {
//                         label: "Username",
...
//                 <Text fontWeight="bold">{fmt(followerCount)} followers</Text>
...
//                 <Text>Activate Your Studio</Text>
...
//                   🎬 Your <b>Studio</b> is your creator identity. Pick a name
//                   that represents your content — it can differ from your
//                   username. This is shown on all your videos and to your
//                   followers.
//                 </Text>
//               </Box>
